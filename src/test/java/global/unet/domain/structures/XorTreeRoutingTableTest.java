...
public class XorTreeRoutingTableTest {
    ...
    private UnionGenerator unionGenerator= new UnionGenerator();

    //TODO тесты на конструктор
    @Test
    public void addNodeTest() throws URISyntaxException {
        //0000 0000 0010 0000
        KademliaId selfId = unionGenerator.createKademliaIdByTemplate(1,(byte) 32, (byte) 0);
        //0000 0000 0111 1111
        KademliaId toId = unionGenerator.createKademliaIdByTemplate(1,(byte) 127, (byte) 0);
    ...
    public void findBucketNumberTest() {
        ...
        //0000 0000 0111 1111
        KademliaId selfId = unionGenerator.createKademliaIdByTemplate(1,(byte) 127, (byte) 0);

        //0000 0000 0010 0000
        KademliaId distanse = unionGenerator.createKademliaIdByTemplate(1,(byte) 32, (byte) 0);
